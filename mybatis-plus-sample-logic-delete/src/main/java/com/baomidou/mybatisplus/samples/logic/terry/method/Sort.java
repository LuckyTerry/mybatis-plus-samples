 ...
 * @since 2018-04-06
 */
public class Sort extends AbstractMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        SqlMethodEnum sqlMethod = SqlMethodEnum.SORT;
        String sql = String.format(sqlMethod.getSql(), tableInfo.getTableName(),
                SqlSetUtils.sqlSortSet(true, tableInfo, Constants.ENTITY_SPOT), sqlWhereEntityWrapper(tableInfo));
