 ...
 * @since 2018-06-13
 */
public class LogicSort extends AbstractMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        SqlMethodEnum sqlMethod = SqlMethodEnum.LOGIC_SORT;
        String sql = String.format(sqlMethod.getSql(), tableInfo.getTableName(),
                SqlSetUtils.sqlSortSet(true, tableInfo, Constants.ENTITY_SPOT),
