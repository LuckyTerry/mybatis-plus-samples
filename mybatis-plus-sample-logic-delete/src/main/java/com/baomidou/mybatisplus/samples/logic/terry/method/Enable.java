 ...
 * @since 2018-04-06
 */
public class Enable extends AbstractMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        SqlMethodEnum sqlMethod = SqlMethodEnum.ENABLE;
        String sql = String.format(sqlMethod.getSql(), tableInfo.getTableName(),
                SqlSetUtils.sqlEnableSet(true, tableInfo, Constants.ENTITY_SPOT), sqlWhereEntityWrapper(tableInfo));
